...
#' pairwise distances.
#'
#' Essentially the same function as \link{MorphDistMatrixFast}, but refactored for speed.
#'
#' @param morph.matrix A character-taxon matrix in the format imported by \link{ReadMorphNexus}.
#' @param distance Which distance matrices to return. Can be one or more of the following \code{"Raw"}, \code{"GED"}, \code{"Gower"}, \code{"Max"}, \code{"Comp"}. By default, the functions returns all 5 matrices.
...
#' # data set:
#' distances <- MorphDistMatrixFast(Michaux1989)
#'
