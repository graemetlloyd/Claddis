...
#' @details
#'
#' Intended for use as an internal function for \link{MatrixTrimmer}, but potentially of more general use.
#'
...
#' nodelabels()
#' 
#' # Use TreeMostRecentCommonAncestor to show that the most recent common
#' # ancestor of B, C, and D is node 6:
#' TreeMostRecentCommonAncestor(c("B", "C", "D"), tree)
#' 
#' @export TreeMostRecentCommonAncestor
TreeMostRecentCommonAncestor <- function(descs, tree) {
