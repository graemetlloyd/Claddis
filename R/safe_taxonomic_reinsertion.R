...
#' @param str.list The safe taxonomic reduction table as generated by \link{safe_taxonomic_reduction}.
...
safe_taxonomic_reinsertion <- function(treefile.in, treefile.out, str.list, multi.placements = "exclude") {
