...
#' # al. (2016) data set:
#' distances <- MatrixDistances(Day2016)
#'
...
#' distances$ComparableCharacterMatrix
#'
#' @export MatrixDistances
MatrixDistances <- function(CladisticMatrix, Distance = "MORD", GEDType = "Wills", TransformDistances = "arcsine_sqrt", PolymorphismBehaviour = "min.difference", UncertaintyBehaviour = "min.difference", InapplicableBehaviour = "missing", CharacterDependencies = NULL, Alpha = 0.5) {
