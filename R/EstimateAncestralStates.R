...
#' EstimateAncestralStates(CladisticMatrix = CladisticMatrix,
#'   Tree = tree)
#' 
#' @export EstimateAncestralStates
EstimateAncestralStates <- function(CladisticMatrix, Tree, EstimateAllNodes = FALSE, EstimateTipValues = FALSE, InapplicablesAsMissing = FALSE, PolymorphismBehaviour = "equalp", UncertaintyBehaviour = "equalp", Threshold = 0.01, AllowAllMissing = FALSE) {
