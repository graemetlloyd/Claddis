...
map_stochastic_changes <- function(cladistic_matrix, time_tree, time_bins, n_simulations = 10, polymorphism_behaviour = "equalp", uncertainty_behaviour = "equalp", inapplicable_behaviour = "missing") {
  ...
  # NEEDS TO HAVE Q MATRICES AS INPUT NOT ESTIMATED BY FUNCTION
  # AND ALLOW PARSIMONY OR OTHER OPTIONS
  
  # THINK ABOUT HOW TO USE FOR CONVERGENCE MEASURES (E.G., MAX AND FINAL DISTANCE FOLLOWING PHYLOGENETIC DIVERGENCE)
  ...
  # MOVE MISSING AS POLYMORPHISM/UNCERTIANTY BEHAVIOUR TO TOP AS MORE EFFICIENT.
