...
#' PlotDisparityStack(ordination_axes = ordination_axes, ages = ages, time_slices = time_slices)
#'
#' # Set random seed:
#' set.seed(17)
#'
...
#' PlotDisparityStack(ordination_axes, ages, groups, time_slices)
#'
#' @export PlotDisparityStack
PlotDisparityStack <- function(ordination_axes, ages, groups = NULL, time_slices, shear = 0.2, x_axis = 1, y_axis = 2, axis_label = "PC") {
