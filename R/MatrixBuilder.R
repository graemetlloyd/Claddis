...
#' MatrixBuilder(CharacterTaxonMatrix)
#'
#' @export MatrixBuilder
MatrixBuilder <- function(CharacterTaxonMatrix, header = "", Weights = NULL, ordering = NULL, symbols = NULL, equalise.weights = FALSE, ignore.duplicate.taxa = FALSE) {
