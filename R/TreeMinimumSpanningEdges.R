...
#' dist.matrix
#' 
#' # Use TreeMinimumSpanningEdges to get the edges for the minimum spanning
#' # tree:
#' TreeMinimumSpanningEdges(dist.matrix)
#' 
#' # Use sum of TreeMinimumSpanningEdges to get the length of the minimum
#' # spanning tree:
#' sum(TreeMinimumSpanningEdges(dist.matrix))
#' 
#' @export TreeMinimumSpanningEdges
TreeMinimumSpanningEdges <- function(dist.matrix) {
